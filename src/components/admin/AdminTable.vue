      ...
      <Table>
        <TableHeader>
          <TableRow class="bg-palette-blue-b/5 hover:bg-palette-blue-b/10">
            ...
            <TableHead v-col-resize colspan="4" class="resizable text-center border-r border-b font-semibold text-palette-blue-a">Данные в Kezekshi-SKUD</TableHead>
            <TableHead v-col-resize colspan="3" class="resizable text-center border-r border-b font-semibold text-palette-blue-a">Данные в Kezekshi-Сore</TableHead>
          </TableRow>
          <TableRow class="bg-palette-blue-b/5 hover:bg-palette-blue-b/10">
            <!-- Всего занесено -->
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во пользователей</TableHead>
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во терминалов</TableHead>
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во событий за период</TableHead>
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Дата и время актуальности данных</TableHead>
            
            <!-- Посетило -->
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во пользователей</TableHead>
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во терминалов</TableHead>
            <TableHead v-col-resize class="resizable text-center border-r text-xs text-muted-foreground">Кол-во событий</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          ...
          >
            ...
            <TableCell class="text-center border-r text-muted-foreground">{{ new Date().toLocaleString() }}</TableCell>
          ...
          <TableRow v-if="totalStats" class="bg-palette-yellow/10 font-bold hover:bg-palette-yellow/20">
            <TableCell class="text-center border-r" colspan="2">Итого</TableCell>
