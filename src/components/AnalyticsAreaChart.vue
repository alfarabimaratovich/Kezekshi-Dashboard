...
<template>
  <Card class="pt-0">
    <CardHeader class="flex flex-col items-start gap-4 border-b py-5 sm:flex-row sm:items-center sm:gap-2">
      <div class="grid flex-1 gap-1">
        <CardTitle>Динамика активности</CardTitle>
        <CardDescription>
          Показаны общие посетители за последние 3 месяца
        </CardDescription>
      </div>
      <Select v-model="timeRange">
        <SelectTrigger
          class="w-full rounded-lg sm:w-40 sm:ml-auto"
